...
/// <summary>
/// Resumes the live lease the caller already holds, so returning to a case they are editing puts
/// them straight back into edit mode. A caller who holds no live lease gets null.
/// </summary>
