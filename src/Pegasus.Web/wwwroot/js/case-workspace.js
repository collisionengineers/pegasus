...
(function () {
    ...
    function showGlassReturnNotice(state) {
        ...
        var text = state === 'Completed'
            ? (session.dataset.glassImportedDirty || "The Glass's estimate was recorded as a repair spec. Your unsaved changes are still here. Save or cancel them to view it.")
