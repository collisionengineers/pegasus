...
(function () {
    ...
    function showGlassReturnNotice(state) {
        ...
        var text = state === 'Completed'
            ? (session.dataset.glassImportedDirty || "The Glass's estimate was recorded and is the repair spec in use. Your unsaved changes are still here. Save or cancel them to view it.")
