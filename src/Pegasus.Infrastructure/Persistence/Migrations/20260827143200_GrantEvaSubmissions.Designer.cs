...
namespace Pegasus.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260827143200_GrantEvaSubmissions")]
    partial class GrantEvaSubmissions
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("EvaSubmissions", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_EvaSubmissions_SucceededAgreesWithOutcome", "([IsSucceeded] = 1 AND [Outcome] = 'Succeeded') OR ([IsSucceeded] = 0 AND [Outcome] <> 'Succeeded')");
                        });
                });
