...
Any change under `Pages/Cases` must also follow the local Case-workspace instructions in that
folder. Do not infer Case layout from a generic page pattern.
