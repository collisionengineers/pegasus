...
- **Authority:** [remaining requirements](../../remaining-requirements.md#3-complete-intake-formats-and-paths) and [ADR-0004](../../../architecture/decisions/ADR-0004-provider-api-and-staff-mcp-authentication.md#internal-staff-mcp).
