...
| 5 | [Case identity and references](casework/case-identity-and-references.md) | Configured principal, trusted actor and durable definitive acceptance evidence | Planned acceptance command | One active allocator; correction/aliases remain withheld by the sent-report decision |
| 6 | [Definitive case acceptance](casework/intake-and-case-acceptance.md#accept-a-definitive-case-transaction) | Orders 1-5 | Planned automatic Worker/provider hand-off plus authenticated Web/manual resolution | One atomic case/reference/audit/outbox transaction |
