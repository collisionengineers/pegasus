...
- **Requirement/decision:** [remaining requirements §4](../../remaining-requirements.md#4-case-model-and-lifecycle) makes a used principal code immutable. A legitimate change creates a new linked principal and atomically deactivates its predecessor.
