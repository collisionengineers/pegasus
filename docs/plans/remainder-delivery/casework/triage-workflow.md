...
- **Authority:** [questionnaire Triage decisions](../../../../PROJECT_DISCOVERY_QUESTIONNAIRE.md#4-the-case-lifecycle), [remaining requirements §3](../../remaining-requirements.md#3-complete-intake-formats-and-paths), and the [combined mailbox/email research boundary](../../open-decisions.md#mailbox-categorisation-and-all-email-matching-research).
