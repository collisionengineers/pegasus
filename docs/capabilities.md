...
| MAIL-09 | Automatic association of related email and attachments with a case | Next | 0.3.0 | [Requirements](requirements.md#email-mailbox-and-background-processing) | The QDOS-direct subset is pulled forward to `Now / 0.1.0-alpha.1` under the operator-accepted predicates in [ADR-0019](adr/0019-accepted-qdos-case-association-predicates.md); general multi-provider association keeps this allocation. |
