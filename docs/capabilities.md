...
| EXT-16 | Collision Engineers guided mobile image capture | Later | 1.4.0 | [Ordinary-image VRM and image analysis](requirements.md#ordinary-image-vrm-and-image-analysis) | Unassigned; later direct decision and separate capture/data contract required. |
| EXT-17 | Tractable or Ravin guided-capture integration | Later | 1.4.0 | [Ordinary-image VRM and image analysis](requirements.md#ordinary-image-vrm-and-image-analysis) | Candidate evidence only; later direct decision and vendor contract required. |
| EXT-19 | Collision Engineers custom application domain | Later | 1.4.0 | [External boundary](requirements.md#external-boundary) | Unassigned; later direct decision required. |
