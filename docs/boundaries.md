...
| `EXT-10` valuation adjustments | the valuation entry with source, guide month and mileage; the Glass's valuation and Glass's estimate-import label entries kept separate (D40, 2026-09-02) | CAP HPI, AutoTrader as a manual source, Vehicle data, valuation adjustments, rationale and revaluation history | `EXT-10`'s later allocation (`TICK-083`) and, for adapters, `EXT-13` |
