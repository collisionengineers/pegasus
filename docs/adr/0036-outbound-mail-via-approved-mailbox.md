...
[boundaries](../prd/pegasus-product.md#permanent-boundaries) listed automated correspondence as excluded
until activation.
...
[runbook approval matrix](../runbook.md#operational-authority).
...
- The application registration needs Graph `Mail.Send` and `Mail.ReadWrite`
  ...
  under the [runbook approval matrix](../runbook.md#operational-authority)
...
- The [boundaries](../prd/pegasus-product.md#permanent-boundaries) correspondence row now reads
