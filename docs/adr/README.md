...
| [ADR-0007: Direct authorised-terminal Azure deployment](0007-direct-terminal-azure-deployment.md) | Partially superseded by ADR-0014 for topology and ADR-0015 for the Web ZIP deployment mechanism. Its authorised-terminal, immutable-artifact, migration, health, smoke, and rollback route remains current. It authorizes no command and proves no deployment. |
