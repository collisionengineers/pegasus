...
[documentation index](../index.md#decision-records). Documentation rules, product
intent, and feature behaviour are **not** ADRs; see the PRD/FRD taxonomy in
[documentation index](../index.md) and the [documentation index](../index.md).

Every ADR carries frontmatter (`id`, `status`, `date`, `supersedes`,
`superseded_by`, `related_capabilities`, `related_frd`, `tags`). Accepted records describe decisions within their surviving scope; they do not
by themselves form a complete current architecture snapshot. An accepted ADR with
...
| [ADR-0009](0009-adopt-pegasus-monorepo-workspaces.md) | Adopt Pegasus monorepo source workspaces | accepted | ADR-0025 | — |
