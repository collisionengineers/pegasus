...
| [ADR-0007: Direct authorised-terminal Azure deployment](0007-direct-terminal-azure-deployment.md) | Partially superseded by ADR-0014 for topology, ADR-0015 for the Web ZIP deployment mechanism, and on its recovery-boundary clause — the RPO/RTO proof follows `0.1.0-alpha.1` acceptance and gates the second release (OPS-09). Its authorised-terminal, immutable-artifact, migration, health, smoke, and rollback route remains current. It authorizes no command and proves no deployment. |
