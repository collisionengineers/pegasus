...
| [ADR-0007: Direct authorised-terminal Azure deployment](0007-direct-terminal-azure-deployment.md) | Partially superseded by ADR-0014: its authorised-terminal, immutable-artifact, migration, health, smoke, and rollback route remains current; its shared Azure development/integration-environment clauses do not. It authorizes no command and proves no deployment. |
