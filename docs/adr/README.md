...
| [ADR-0011: Restrict MCP to the Claude Automation Actor](0011-restrict-mcp-to-claude-automation-actor.md) | Accepted. MCP is a management/development-controlled ingress for the named Claude Automation Actor; ordinary staff have no MCP access. Core remains the authorization and permanent-history owner; no endpoint, client, caller, deployment, or acceptance is implied. |
