...
- Python mirror (sibling-first per ADR-0018, commit `8e7f2f7`, tag **engine-`Next`/`unallocated`.10**, re-vendored):
...
**Deploys/probes:** parser republished at engine-`Next`/`unallocated`.10 (`--build remote`); orch republished (the
