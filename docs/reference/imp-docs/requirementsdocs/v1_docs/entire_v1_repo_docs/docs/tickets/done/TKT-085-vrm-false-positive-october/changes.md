...
The live FC1 parse of the attached Audatex PDF surfaced the month word; a local engine-`Next`/`unallocated`.10 re-parse
...
**Shipped (sibling-first, commit `8e7f2f7`, tag engine-`Next`/`unallocated`.10, re-vendored):**
...
**Deploys:** parser (engine-`Next`/`unallocated`.10) + api + orch republished 2026-07-09.
