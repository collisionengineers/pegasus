...
The settled questionnaire and canonical [EVA requirements](../../requirements.md#focused-eva-manual-handoff) now record the API as preferred once available and the focused-`0.1.0-alpha.1` JSON/image handoff as the current route. The EVA delivery plan keeps field mapping, image selection, readiness and recovery behind operator approval.
