...
| `docs/history/product/project-discovery-questionnaire.md` | distilled direct-decision evidence | historical; preserve direct decisions and route living behavior to canonical product owners | no longer a parallel product authority |
| `docs/history/product/feature-versioning-worksheet.md` | retained allocation worksheet evidence | historical; preserve the converted 213-row interview shape | canonical allocation remains the 229-ID capability inventory |
