...
- Pass the exact operator label in its settled casing: `Not ready`, `Review`, `Held`, `Completed`, `Needs sorting`, `Blocked`, `Stale`, `Refreshing`, `Denied`, `Lease held`… The chip never rewrites the words.
