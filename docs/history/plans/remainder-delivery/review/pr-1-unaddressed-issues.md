...
The repeated-DOCX-image thread needs a decision rather than an automatic fix: [ADR-0005](../../../../adr/0005-multiformat-intake-assets.md) says retain every occurrence but later explicitly describes URI-deduplicated traversal. Clarify whether “occurrence” means an image package part or every document placement.
