...
- **Authority:** [remaining requirements](../../../../product/qdos-alpha-gap.md#6-box-vehicle-data-eva-and-email) and [ADR-0002](../../../../adr/0002-dotnet-modular-monolith-on-azure.md#files-box-and-document-processing). No exact development root is authorised by this plan.
