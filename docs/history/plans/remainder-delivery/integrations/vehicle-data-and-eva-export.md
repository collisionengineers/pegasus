...
- **Authority:** [remaining requirements](../../../../product/qdos-alpha-gap.md#6-box-vehicle-data-eva-and-email), [ADR-0002](../../../../adr/0002-dotnet-modular-monolith-on-azure.md), and the authoritative [EVA operator note](../../../../operator-notes/systems-and-integrations/eva.md).
