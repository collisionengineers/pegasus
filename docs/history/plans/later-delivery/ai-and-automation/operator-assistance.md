...
Features: `AI-01`; `AI-02`; `AI-03`; `AI-04`; `AI-06` — `Later`/`unallocated` release work.
Pre-conversion status: **Planned activation/evaluation contracts; no AI caller, model, vendor or policy is implemented.**
...
Feature: `AI-06` — `Later`/`unallocated` release work.
