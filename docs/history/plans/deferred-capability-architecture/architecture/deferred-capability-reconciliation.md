...
- **Authority order:** authoritative [operator requirements](../../../../operator-notes.md), settled [discovery-questionnaire](../../../product/project-discovery-questionnaire.md) answers, and accepted [architecture decisions](../../../../adr/) retain their repository-defined authority. Canonical [requirements](../../../../requirements.md) own intended behavior, [capabilities](../../../../capabilities.md) owns allocation, and [open decisions](../../../../open-decisions.md) is the ambiguity register; this historical plan overrides none of them.
