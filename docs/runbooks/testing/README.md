...
- Apply the repository [source-of-truth order](../../agent-guidance/source-of-truth.md), the settled [project questionnaire](../../../PROJECT_DISCOVERY_QUESTIONNAIRE.md), the [remaining first-release requirements](../../product/v1-gap.md), and accepted [Azure architecture](../../architecture/decisions/ADR-0002-dotnet-modular-monolith-on-azure.md).
