...
- **Deployed evidence:** the estate currently serves **release 32**. A branch
  ...
  **a source revision is a release claim only when it changes something under
  ...
  |---|---|---|---|---|---|
  | 32 | 2026-08-26 | `cfb3e6cf…` | `sha256:bac866ee…` | `pegasus-prod-web-252ow37gij--cfb3e6cfd838` | none (head unchanged at `20260825145216_MailboxImageIntake`) |
  ...
  - **Release 32** (2026-08-26, source `cfb3e6cf`, image
    `sha256:bac866ee…`, manifest SHA-256 `C3A368CB…`) deployed immediate
