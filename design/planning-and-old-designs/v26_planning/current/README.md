...
| `v26-notes.md` | What v26 changes and why, the Glass's rules it mirrors, the three damage clicker variants, the working-set tab strip, the image viewer, the replica pass over every live surface, and the new sign-off items G–R. |
...
Stage 2. See `v25-notes.md` (A–F) and `v26-notes.md` (G–R) for the decisions
awaiting sign-off.
