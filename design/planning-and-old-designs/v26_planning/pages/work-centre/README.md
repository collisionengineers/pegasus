...
- [**How it works**](how-it-works.md) — the live behaviour, with the FRD, ADR and source references.
- [**How it should work**](how-it-should-work.md) — decisions D1 to D6 for the FRD.
