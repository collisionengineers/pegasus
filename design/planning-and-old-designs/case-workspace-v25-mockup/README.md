...
| `v26-notes.md` | What v26 changes and why, the Glass's rules it mirrors, the three damage clicker variants, the working-set tab strip, the image viewer, and the new sign-off items G–Q. |
...
Stage 2. See `v25-notes.md` (A–F) and `v26-notes.md` (G–Q) for the decisions
awaiting sign-off.
