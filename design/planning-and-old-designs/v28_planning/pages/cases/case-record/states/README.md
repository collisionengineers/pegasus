...
- **Live source:** `src/Pegasus.Web/Pages/Cases/Details.cshtml`, `src/Pegasus.Web/Pages/Cases/Details.Frame.cs`
...
- See the Case record page for the states the fixture cannot reach.
