...
function computeText() {
  ...
  t.engineer = (F.notReady || F.isReview || F.isHeld) ? 'Not recorded' : 'A Patterson';
...
function mockAction(name, form) {
  switch (name) {
    ...
    case 'hand-to-engineer': case 'assign-to-me': closeDialog(); S.state = 'with-engineer'; apply(); notice('The Case was handed to A Patterson.'); return;
    ...
    case 'generate': S.report = 'confirmed'; apply(); notice('The report was generated.'); return;
