# v30 current: five Upload flow alternatives
...
| Option | Design | Open |
| --- | --- | --- |
| A | Decision beside compact files | [A](pegasus_upload_a_v30.html?state=decision) |
| B | Guided single column | [B](pegasus_upload_b_v30.html?state=decision) |
| C | Destination first, files in evidence index | [C](pegasus_upload_c_v30.html?state=decision) |
| D | Full-width operations table | [D](pegasus_upload_d_v30.html?state=decision) |
| E | Evidence gallery | [E](pegasus_upload_e_v30.html?state=decision) |
...
The [notes](v30-notes.md) compare the options and hold the lettered sign-off
list. The [discussion log](discussion-log.md) records feedback. The
[self-check](v30-selfcheck.html) and [screenshots](v30-shots/) are design
