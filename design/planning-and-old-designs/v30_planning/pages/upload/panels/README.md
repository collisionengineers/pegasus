...
The proposals vary only the Upload content inside the Pegasus shell:

- A: file ledger left, destination right.
- B: step header, then the active choice above the file list.
- C: destination work area left, compact evidence index right.
