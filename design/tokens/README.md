...
- Current runtime: `src/Pegasus.Web/wwwroot/css/site.css` (partially aligned; not generated)

## Token groups

| Group | Adapted values retained for Pegasus |
| --- | --- |
...
| State | success `#16833B`; amber incomplete/pending and navy Review remain owned by the Pegasus UI plan/current implementation until selected design reconciliation |
