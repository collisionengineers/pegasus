...
- Repository skills have one canonical body under `.agents/skills/`. The
  `.claude/skills/`, `.codex/skills/` and `.zcode/skills/` copies are tracked
  pointer stubs that link to it; `.claude/` is otherwise ignored.
