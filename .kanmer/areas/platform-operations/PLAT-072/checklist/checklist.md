...
- [x] Root clears overlapping retained claims and ENG-041 fixture; obtain real execution packet and own fresh worktree before edits.
...
Implementation, independent review and exact merged proof are complete;
ordinary Done is accepted on dev. Final converged release evidence remains;
no deployment claim.
