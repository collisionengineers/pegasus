...
## Locked-state amendment — 2026-08-25

PR-061 found that the first Review read preceded package construction and the recording lock. Commit cc6b0ee7 makes the existing locked workflow query return State and rejects a demotion before replay/proxy/history. This refines enforcement only; it does not add another readiness policy.
