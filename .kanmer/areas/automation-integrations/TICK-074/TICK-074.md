...
links: []
archived: false
created: '2026-08-12T15:05:39.972Z'
updated: '2026-08-17T06:41:46.261Z'
---

## What

Plan and research **AI-06**: AI-assisted inspection-address suggestions

## Why

This is allocated to **Later / 0.6.0** in `docs/capabilities.md`. It is **not designated until post-alpha** and is blocked from implementation pending its activation decision and evidence.
...
- Source: `docs/capabilities.md` — AI-06.
