...
| `src/Pegasus.Web/Automation` | Real staff or Automation caller; thin orchestration only |
| `tests/Pegasus.IntegrationTests/AutomationMcpIntegrationTests.cs` | Focused acceptance and regression evidence |
