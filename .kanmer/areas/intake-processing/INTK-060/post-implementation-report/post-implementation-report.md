...
`fbbcff265ffb0c84df8be85b704be1d507951802`. It records the current
...
The ticket remains in Implementing while new CI run 34131467006, formal
...
independent A source PASS. The Glass fixture changes preserve all inputs and
assertions while making every row serializable and uniquely discoverable.
...
New CI run 34131467006 must finish on the exact candidate. A fresh whole-PR
