...
- Commit: `7b5707f20`
- Path: `.kanmer/areas/intake-processing/INTK-060/scratch/pr-671-disposition.md`

Recover with:

```powershell
git -C .worktrees/kanmer show "7b5707f20:.kanmer/areas/intake-processing/INTK-060/scratch/pr-671-disposition.md"
```
