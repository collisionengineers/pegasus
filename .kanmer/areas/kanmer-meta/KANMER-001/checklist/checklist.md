...
- [x] Snapshot and classify all affected live-board records with concurrency tokens.
- [x] Retarget all docs/requirements.md canonical-owner ticket links to verified FRD anchors.
- [x] Retarget the five substantive NOW.md ticket bodies without archiving them.
- [x] Preserve and retarget evolved EPIC-001 CI tickets TICK-194, TICK-195, TICK-197, and TICK-200.
- [x] Preserve and consolidate renderer tickets TICK-203 through TICK-216 through SIMPLI-015 context.
- [x] Archive only freshly confirmed non-actionable boilerplate imports, recording an audit note.
