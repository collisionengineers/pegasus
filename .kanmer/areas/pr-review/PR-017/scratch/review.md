...
**Specific fix passes.** The authenticated `/Inbox` caller now proves a zero-retained-row approved mailbox is selectable and sends exact scope/search/100 bound. Shared PR still needs changes elsewhere, so this ticket remains in Review.
