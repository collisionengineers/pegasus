...
Mapped HttpClient timeout `TaskCanceledException` to Deleted-search unavailable only when the request cancellation token was not cancelled. Added proofs for timeout and genuine caller cancellation propagation.
