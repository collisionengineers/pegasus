...
| Path | Purpose / risk |
| --- | --- |
| `src/Pegasus.Core/Intake/MailboxIntake.cs` | Core-owned contract/policy; reuse existing vocabulary and avoid a second business implementation |
...
| `tests/Pegasus.IntegrationTests/RetainedMailPersistenceTests.cs` | Focused acceptance and regression evidence |
