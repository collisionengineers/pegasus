...
| Path | Purpose / risk |
| --- | --- |
| `src/Pegasus.Core/Workflow/PollSentEvidence.cs` | Core-owned contract/policy; reuse existing vocabulary and avoid a second business implementation |
...
| `tests/Pegasus.Core.Tests/Workflow/PollSentEvidenceTests.cs` | Focused acceptance and regression evidence |
