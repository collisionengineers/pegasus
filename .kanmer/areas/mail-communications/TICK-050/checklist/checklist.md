...
- [x] Create the TICK-050 worktree/branch from exact `origin/dev` `e4d56d9e` and take the ticket.
- [x] Add one nullable Core suggested-Move projection derived solely from current `FolderRecommendation.CanMove`.
- [x] Render the labelled advisory and reuse the unchanged MAIL-07 confirmation/status paths.
