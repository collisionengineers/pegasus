/* Lucide icon helper for the Collision Engineers website kit.
   Inlined paths (stroke-width 2, round caps) matching lucide.dev. */
const CE_ICONS = {
...
function CEIcon({ name, size = 24, fill = false, style, className }) {
  const inner = CE_ICONS[name] || "";
  return (
    <svg
