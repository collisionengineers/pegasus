...
public sealed class AxInstructionExtractionPolicyTests
{
    ...
    [InlineData("13509b46340a-AX_04.pdf.txt", "1063506", "Mr slawomir Kluska", "SH20ZFM", "RENAULT CLIO RS LINE TCE", "2026-05-02", "2026-05-05", "2026-05-07", "Client stationary in a queue of traffic and the tp behind our client failed to stop and shunted our client in the rear. Details exchanged.", "Ultimate Car Body Repairs Ltd", "ML4 2RS", "07564 090038/07935473921")]
    [InlineData("fe98b1e7532c-AX_05.pdf.txt", "1063118", "Miss Stevie-Leigh Reynolds", "PN64WBO", "RENAULT CLIO DYNAMIQUE MEDIANAV", "2026-04-29", "2026-05-05", "2026-05-07", "Our client was proceeding down Crammond Ave - Third Party has failed to giveway and pulled out of Aitkenhead Ave and collided into the Nearside of our clients vehicle. Details Exchanged", "Lanarkshire ARC", "ML1 1PF", "07827446300")]
    public void RecordedClientBlocksRemainDistinctFromBodyshopAndThirdParty(
        ...
        string repairer, string repairerPostcode, string repairerTelephone)
    {
        ...
        Assert.Equal(deadline, DateOnly.Parse(
            Field(result, "Report deadline")!, System.Globalization.CultureInfo.InvariantCulture)
