...
public sealed class SblInstructionExtractionPolicyTests
{
    ...
    public void RecordedSectionsRemainRoleScoped(
        ...
        string registration, string vehicle, string incidentDate,
    ...
    public void ExplicitHireDateUsesOnlyTheNonblankRoleLabel()
    {
        ...
        Assert.DoesNotContain(result.Fields, field =>
            field.Name.Contains("SBL ", StringComparison.Ordinal));
    }
