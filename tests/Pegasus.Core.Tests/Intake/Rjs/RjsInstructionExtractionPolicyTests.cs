...
public sealed class RjsInstructionExtractionPolicyTests
{
    ...
    public void RecordedInstructionsPreserveIndependentMakeModelAndContactRoles(
        ...
        string registration, string make, string? model, string incidentDate,
