...
public sealed class DfdInstructionExtractionPolicyTests
{
    ...
    [InlineData("3963d0e94ba1-DFD_01.pdf.txt", "DFD 01.pdf", "a8eebc6d0c4088cd8d7a1ccff8dc690a5f8a13c96457d1bc04b1aed7b4930782", "RJP/81517", "Samantha Wilson", "2026-04-28", "LS69OYW", "TBC", "TPV reverses into our o/s from a side road", "DFD")]
    [InlineData("7b34209b42ae-DFD_02.pdf.txt", "DFD 02.pdf", "10f47df9a02a19c111e0ad07d9f739e904b4665fbe8a452640f4f7a1814fb72d", "RJP/81516", "Henry Jones", "2026-04-29", "YS19OUA", "Car 2 Go", "TP pulls from side road into our path", "Car 2 Go")]
    [InlineData("1e59ede6a8e1-DFD_03.pdf.txt", "DFD 03.pdf", "bc276820f055a184e8ca0f977b59e5bcdeb703ed15ebff24772f24511d0760d1", "RJP/81513", "Farid Erfani", "2026-04-24", "DA17PGO", "SMC", "TP pulls onto roundabout into our rear n/s", "SMC")]
    [InlineData("dfb9201274d6-DFD_04.pdf.txt", "DFD 04.pdf", "6b27e492c18fbb4fde08ec059acbc3a79a18e2db4fa5036dfbae32224d96744b", "RJP/81509", "Ali Abdul", "2026-04-14", "KJ17HHR", "Whippendell Road, Watford", "Hit whilst parked", "DFD")]
    [InlineData("30d1d453e4fd-DFD_05.pdf.txt", "DFD 05.pdf", "ee4fab522c6f4bb5b3fbc693f405ac6282aa166d9af5bf9868f0f9a0d728019d", "RJP/81508", "Alan Joseph", "2026-04-01", "GV12RHF", "SMC", "Parked car we are passing opens door into out path", "SMC")]
    public void RecordedFormFieldsRemainGeometryBound(string extractedFile, string originalFile, string sha256,
        string reference, string claimant, string incidentDate, string registration,
        string location, string circumstances, string source)
    {
        ...
        var result = Extract(reference, claimant, incidentDate, registration, location, circumstances, source);
    ...
    {
        string[] names = ["Text4", "Text6", "Text7", "Text8", "Text10", "Text11", "Text13"];
