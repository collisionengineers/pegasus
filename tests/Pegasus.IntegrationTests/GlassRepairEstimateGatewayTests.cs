...
{
    private const string Registration = GlassEstimateXmlParserTests.GlassExport.Registration;
    private const string NatCode = GlassEstimateXmlParserTests.GlassExport.TypeNumber;
    private const long MileageMiles = 33000;
    private const string VehicleId = "33584499";
    private const string EreId = "1954488";
    private const string EreSession = "me3d4aa4kg79prs0do2emalhc5";
    private const string ProfileId = "4063";
    private const string SavedQuery =
        "?Total=0&DoSave=1&ErrMsg=D%3A%2Fvar%2Fdb%2Feremware%2Fresponse%2F1788356510_008376.xml";

    private static readonly Uri MvaBase = new("https://mva.test/");
    private static readonly Uri EstimatorBase = new("https://ere.test/");
    private static readonly Uri CallbackBase = new("https://pegasus.test/");
    ...
    private static string LaunchUrl(string? caller = null) =>
    ...
    private sealed class Harness
    {
        ...
        /// <summary>
        /// The provider's own answers, in the shapes the supplied captures
        /// record: byte-order marked JSON, a same-origin login redirect, the
        /// candidate fragment naming its type number, and a launch URL whose
        /// caller is a Glass's ERE callback.
        /// </summary>
        private static void Script(ScriptedGlass mva)
        {
