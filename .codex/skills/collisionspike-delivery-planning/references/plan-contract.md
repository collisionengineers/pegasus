...
4. **Caller and contract** — real or intended entry point, inputs, outputs, ordered decisions, failure/unknown outcomes, actor/audit behavior, edit ownership and concurrent/stale caller behavior.
