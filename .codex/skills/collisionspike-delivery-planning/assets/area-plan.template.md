...
<Typed failures, operator-visible outcomes, audit events, telemetry and retry boundaries shared by this area.>
...
- **Ordered decisions and failure behavior:** <policy, unknown outcome, actor and audit>
...
- **Operator surface and observability:** <UI, audit and content-safe telemetry>
