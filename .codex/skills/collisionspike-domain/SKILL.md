...
- Inspection plus audit starts as a normal inspection. After assessment, the engineer creates the applicable audit reference and Box subfolder.
...
Read [domain-invariants.md](references/domain-invariants.md) before implementing business behavior. Read [open-decisions.md](references/open-decisions.md) before committing a schema or state machine.
