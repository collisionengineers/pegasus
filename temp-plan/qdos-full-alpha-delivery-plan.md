...
- Add pinned Playwright/axe dependencies to the existing Integration test project; update only the centralized root quick start and `docs/operations.md` local-development/testing procedures—no replacement runbook tree.
