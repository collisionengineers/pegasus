...
> **Design authority:** [`../../../docs/design/README.md`](../../../docs/design/README.md) governs the linked design assets. Build and test changes must preserve that single source rather than adding workspace-local copies.
