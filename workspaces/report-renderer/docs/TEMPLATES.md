...
The Core `.csproj` links and embeds `design\assets\report-renderer\templates\**\*`;
`EmbeddedResources` resolves templates by their trailing path, so no loader edit is needed.
