...
layout API. The canonical stylesheet is `src/CollisionRenderer.Core/Assets/templates/report.css`,
embedded in Core, with a data register at 8.8 pt for the valuation/evidence/fee documents and
a letter register at 10 pt for expert reports. Because Chromium is the renderer (ADR 0001),
