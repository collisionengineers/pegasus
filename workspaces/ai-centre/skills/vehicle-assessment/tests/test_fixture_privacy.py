...
def iter_packaged_files():
    """Yield text files that tools/pack_skill.py ships.

    Technical tests are retained outside the packaged skill payload. Fixtures are
    scanned separately by the fixture-specific checks below.
    """
