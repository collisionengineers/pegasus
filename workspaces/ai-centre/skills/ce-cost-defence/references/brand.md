...
- **Brand red:** `#C8102E` — title text, section-heading underline rules, table header fill, footer website line.
- **Body text:** near-black `#2B2B2B`.
- **Table borders / footer rule:** light grey `#BFBFBF`.
- **Alternating row shade / label cells:** `#F2F2F2`.
- **Table header text:** white on red.

## Typography & layout

- **Font:** Arial throughout. Body ~10.5pt, justified. Section headings bold, uppercase, ~11pt with a red bottom-border rule.
- **Page:** A4, ~0.79in side margins, larger top margin to clear the logo header band.
- **Title:** centred, bold, underlined, uppercase.
- **RE line:** centred, bold, directly under the title.
- **Header band (every page):** logo left; Our Ref / Your Ref / Date right-aligned and bold-labelled.
- **Footer band (every page):** centred red website line over a grey registered-address line, separated from the body by a thin grey top rule.
