...
The wider product, architecture, repository-development, operations, and decision context remains owned by the [documentation index](../../../docs/index.md), [requirements](../../../docs/requirements.md), [capabilities](../../../docs/capabilities.md), [architecture](architecture.md), [engineering](../../../docs/engineering.md), [operations](../../../docs/operations.md), [operator notes](../../../docs/operator-notes.md), [open decisions](../../../docs/open-decisions.md), and the [decision index](../../../docs/adr/README.md).
