...
This document is the canonical owner for the document-extraction test programme, fixture controls and dated evidence. Product intent and support boundaries are owned by [requirements](../../../docs/requirements.md), [capabilities](../../../docs/capabilities.md), [architecture](architecture.md) and [open decisions](../../../docs/open-decisions.md). Build and contribution policy is owned by [engineering](../../../docs/engineering.md); runbooks and operational handling are owned by the [runbook](../../../docs/runbook.md), with current operational evidence in [operations](../../../docs/operations.md) and business truth in [operator notes](../../../docs/operator-notes.md).
