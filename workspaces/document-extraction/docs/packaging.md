...
Operational handling remains subject to the [operations guidance](../../../docs/operations.md) and [operator notes](../../../docs/operator-notes.md). Architecture and implementation changes must follow the [architecture](architecture.md), [engineering guidance](../../../docs/engineering.md), and applicable [decision records](../../../docs/decisions/README.md).
